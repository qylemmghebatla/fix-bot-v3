...
global.sig = 'https://instagram.com/jstme._____' // ig
global.sgh = 'https://github.com/WH-MODS-BOT/' // github
global.sgc = 'https://chat.whatsapp.com/LeDdAeRGBXNCRz1u4TH0f3' // group whatsapp
...
/*============== PAYMENT ==============*/
global.Maxis = 'https://wa.me/60177302593?text=hello+nak+sewa+bot+bole+tak' //dana
global.Celcom = 'https://wa.me/601140892512?text=hello+nak+sewa+bot+bole+tak' //ovo
global.pgopay = '-' //gopay
...
/*============== WATERMARK ==============*/
global.wm = '                「 𝔮𝔶𝔩𝔢𝔫𝔰𝔢𝔪𝔟𝔬𝔱𝔷 」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘𝔮𝔶𝔩𝔢𝔫𝔰𝔢𝔪𝔟𝔬𝔱𝔷 ˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ 𝔮𝔶𝔩𝔢𝔫𝔰𝔢𝔪𝔟𝔬𝔱𝔷 '
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot | By 𝔮𝔶𝔩𝔢𝔫𝔰𝔢𝔪𝔟𝔬𝔱𝔷
global.packname = '☂︎ ᴄʀᴇᴀᴛᴇᴅ ʙʏ'
global.author = '                「 𝔮𝔶𝔩𝔢𝔫𝔰𝔢𝔪𝔟𝔬𝔱𝔷  あ」'
